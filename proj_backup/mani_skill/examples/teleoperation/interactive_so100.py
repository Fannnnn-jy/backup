...
from mani_skill.examples.motionplanning.so100.motionplanner import SO100ArmMotionPlanningSolver
    ...
    while True:
        ...
        if execute_current_pose:
            ...
            target_pose = sapien.Pose(
                p=fixed_jaw_tip_position.p - planner._so_100_grasp_pose_tcp_transform.p, q=fixed_jaw_tip_position.q
            )
