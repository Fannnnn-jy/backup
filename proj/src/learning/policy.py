...
try:
    from .vggt_relative_actor_critic import VGGTRelativeActorCritic
except ImportError:  # pragma: no cover - fallback for src.* imports
    from src.learning.vggt_relative_actor_critic import VGGTRelativeActorCritic
...
def register_custom_models() -> None:
    ...
    rsl_modules.VGGTRelativeActorCritic = VGGTRelativeActorCritic
    rsl_runner.VGGTRelativeActorCritic = VGGTRelativeActorCritic
