...
class RenderState:
    ...
    last_new_voxel_count: int = 0
    last_seen_voxel_count: int = 0
...
def init_render_state(cfg: Any) -> RenderState:
    return RenderState(
        prev_position=None,
        last_heading=None,
        carved_occupied=None,
        carved_free=None,
        show_error_overlay=False,
        last_new_voxel_count=0,
        last_seen_voxel_count=0,
    )


def reset_render_state(state: RenderState) -> None:
    state.carved_occupied = None
    state.carved_free = None
    state.show_error_overlay = False
    state.last_new_voxel_count = 0
    state.last_seen_voxel_count = 0
