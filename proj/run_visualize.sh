...
# echo "Visualization"
# python src/scripts/visualize_active_backup.py  /home/ghr/fs/Junyi/data/proj/training_set_replicaCAD/v3_sc2_staging_18.glb \
...
python src/scripts/visualize_active.py /home/ghr/fs/Junyi/data/proj/actrec_data/dst_data/procthor/ProcTHOR-Test-21.glb