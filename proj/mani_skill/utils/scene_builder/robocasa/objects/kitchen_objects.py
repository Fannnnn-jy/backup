...
OBJ_CATEGORIES = dict(
    ...
    kettle_electric=dict(
        ...
        objaverse=dict(
            ...
            exclude=[f"kettle_{i}" for i in range(29) if i not in [0, 7, 9, 12, 13, 17, 24, 25, 26, 27]],
        ),
        aigen=dict(
            scale=1.5,
    ...
    kettle_non_electric=dict(
        ...
        objaverse=dict(
            scale=1.35,
            model_folders=["objaverse/kettle"],
            exclude=[f"kettle_{i}" for i in range(29) if i in [0, 7, 9, 12, 13, 17, 24, 25, 26, 27]],
        ),
        aigen=dict(
            scale=1.5,
            model_folders=["aigen_objs/kettle"],
    ...
    pot=dict(
        ...
        objaverse=dict(
            ...
            scale=1.70,
            exclude=list(set([f"pan_{i}" for i in range(25)]) - set(["pan_0", "pan_12", "pan_17", "pan_22"])),
        ),
    ),
    peach=dict(
        types=("fruit"),
