...
@register_env("InsertFlower-v1", max_episode_steps=300, asset_download_ids=["oakink-v2"])
class InsertFlowerEnv(BaseEnv):
    agent: FloatingAbilityHandRight
    _clearance = 0.003
    ...
    def _load_scene(self, options: dict):
        ...
        vase_collision_mesh_file = os.path.join(self.asset_path, "O02@0080@00001/model.obj.coacd.ply")
        ...
        flower_collision_file = os.path.join(self.asset_path, "O02@0081@00001/model.obj.coacd.ply")
        ...
        self.initial_flower_pos = torch.tensor([-0.242, 0.0, 0.015 + 0.001], device=self.device)
        self.initial_flower_quat = torch.tensor([-0.352413, -0.258145, -0.635074, 0.637062], device=self.device)
