...
@register_env("AssemblingKits-v1", asset_download_ids=["assembling_kits"], max_episode_steps=200)
class AssemblingKitsEnv(BaseEnv):
    ...
    **Success Conditions:**
    ...
    _sample_video_link = (
        "https://github.com/haosulab/ManiSkill/raw/main/figures/environment_demos/AssemblingKits-v1_rt.mp4"
    )
    ...
    def _get_object_builder(self, object_id: str, static: bool = False, color_id: int = 0):
    ...
    def _check_rot_diff(self, rot_eps=np.deg2rad(4)):
        ...
        rot_diff[has_half_symmetries] = (
            self.symmetry[self.object_ids][has_half_symmetries] - rot_diff_sym[has_half_symmetries]
        )
