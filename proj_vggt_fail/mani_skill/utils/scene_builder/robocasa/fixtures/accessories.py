...
class Accessory(Fixture):
    ...
    def __init__(self, scene, xml, name, pos=None, *args, **kwargs):
        super().__init__(scene=scene, xml=xml, name=name, duplicate_collision_geoms=False, pos=pos, *args, **kwargs)
...
class CoffeeMachine(Accessory):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._receptacle_pouring_site = self.worldbody.find(
            "./body/body/site[@name='{}{}']".format(self.naming_prefix, "receptacle_place_site")
        )
