    ...
    "minimal": ShaderConfig(
        ...
        texture_transforms={
            ...
            "PositionSegmentation": lambda data: {
                "position": data[..., :3],  # position for minimal is in millimeters and is uint16
                "depth": -data[..., [2]],
                "segmentation": data[..., [3]],
            },
        },
...
def set_shader_pack(shader_config: ShaderConfig):
    ...
    if SAPIEN_RENDER_SYSTEM == "3.0":
        ...
        if shader_config.shader_pack[:2] == "rt":
            ...
            sapien.render.set_ray_tracing_path_depth(shader_config.shader_pack_config["ray_tracing_path_depth"])
            sapien.render.set_ray_tracing_denoiser(shader_config.shader_pack_config["ray_tracing_denoiser"])
