...
class EnvSpec:
    def __init__(
        ...
        asset_download_ids: list[str] | None = [],
        ...
        for asset_id in self.asset_download_ids or []:
            ...
            if is_data_group:
                ...
                if not assets.is_data_source_downloaded(asset_id):
                    ...
                    print(f"Could not find asset {asset_id} at {data_source.output_dir / data_source.target_path}")
...
class TimeLimitWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        if self._max_episode_steps is not None:
            ...
            truncated = torch.zeros((self.base_env.num_envs,), dtype=torch.bool, device=self.base_env.device)
