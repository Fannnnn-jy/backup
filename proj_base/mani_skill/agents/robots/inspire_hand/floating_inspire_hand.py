...
class FloatingInspireHandRight(BaseAgent):
    ...
    urdf_config = dict(
        _materials=dict(finger=dict(static_friction=2.0, dynamic_friction=2.0, restitution=0.0)),
        link=dict(
            right_hand_hand_base_link=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_thumb_distal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_thumb_metacarpal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_thumb_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_index_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_index_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_middle_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_middle_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_ring_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_ring_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_pinky_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            right_hand_pinky_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
        ),
    )
...
class FloatingInspireHandLeft(BaseAgent):
    ...
    urdf_config = dict(
        _materials=dict(finger=dict(static_friction=2.0, dynamic_friction=2.0, restitution=0.0)),
        link=dict(
            left_hand_hand_base_link=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_thumb_distal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_thumb_metacarpal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_thumb_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_index_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_index_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_middle_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_middle_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_ring_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_ring_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_pinky_proximal=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
            left_hand_pinky_middle=dict(material="finger", patch_radius=0.1, min_patch_radius=0.1),
        ),
    )
    disable_self_collisions = True
    # you could model all of the fingers and disable certain impossible self collisions that occur
