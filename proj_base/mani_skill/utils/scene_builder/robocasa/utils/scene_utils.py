...
def load_style_config(style, fixture_config):
    ...
    yaml_path = str(ASSET_DIR / f"scene_datasets/robocasa_dataset/assets/fixtures/fixture_registry/{fixture_type}.yaml")
    ...
    for cfg_id in config_ids:
        if cfg_id in default_configs:
            ...
            raise ValueError(f'Did not find style that matches "{cfg_id}" for fixture type "{fixture_type}"')
    return config
