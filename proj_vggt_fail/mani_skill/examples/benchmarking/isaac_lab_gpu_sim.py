...
parser.add_argument(
    "--save-example-image", action="store_true", help="Save the last image output of each modality and camera to disk"
)
...
parser.add_argument(
    "--cam-height", type=int, default=None, help="Height of cameras. Only used by benchmark environments"
)
parser.add_argument("--seed", type=int, default=None, help="Seed used for the environment")
parser.add_argument("--save-results", action="store_true", help="whether to save results to a csv file")
