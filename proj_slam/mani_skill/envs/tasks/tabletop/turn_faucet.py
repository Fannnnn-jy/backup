...
class TurnFaucetEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        for i, model_id in enumerate(model_ids):
            ...
            switch_link = faucet.links_map[switch_link_names[switch_link_ids[i] % len(switch_link_names)]]
    ...
    def _initialize_episode(self, env_idx: torch.Tensor, options: dict):
        with torch.device(self.device):
            ...
            q = randomization.random_quaternions(n=b, lock_x=True, lock_y=True, bounds=(-torch.pi / 12, torch.pi / 12))
            ...
            cmass_pose = self.target_switch_link.pose * self.target_switch_link.cmass_local_pose
