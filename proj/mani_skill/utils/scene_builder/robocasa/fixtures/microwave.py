...
class Microwave(Fixture):
    ...
    def update_state(self, env):
        ...
        """
        start_button_pressed = env.check_contact(env.robots[0].gripper["right"], f"{self.name}_start_button")
        stop_button_pressed = env.check_contact(env.robots[0].gripper["right"], f"{self.name}_stop_button")
