...
class TableTopFreeDrawEnv(BaseEnv):
    ...
    **Goal Specification:**
    ...
    _sample_video_link = (
        "https://github.com/haosulab/ManiSkill/raw/main/figures/environment_demos/TableTopFreeDraw-v1_rt.mp4"
    )
    ...
    def _after_control_step(self):
        ...
        self.dots[self.draw_step].set_pose(Pose.create_from_pq(robot_brush_pos, euler2quat(0, np.pi / 2, 0)))
        self.draw_step += 1
