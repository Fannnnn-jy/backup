...
try:
    from .slamformer_relative_actor_critic import SLAMFormerRelativeActorCritic
except ImportError:  # pragma: no cover - fallback for src.* imports
    from src.learning.slamformer_relative_actor_critic import SLAMFormerRelativeActorCritic
...
def register_custom_models() -> None:
    ...
    rsl_modules.SLAMFormerRelativeActorCritic = SLAMFormerRelativeActorCritic
    rsl_runner.SLAMFormerRelativeActorCritic = SLAMFormerRelativeActorCritic
