...
class PegInsertionSideEnv(BaseEnv):
    ...
    **Success Conditions:**
    ...
    _sample_video_link = (
        "https://github.com/haosulab/ManiSkill/raw/main/figures/environment_demos/PegInsertionSide-v1_rt.mp4"
    )
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: dict):
        ...
        gripper_to_peg_dist = torch.linalg.norm(gripper_pos - tgt_gripper_pose.p, axis=1)
        ...
        peg_head_wrt_goal_yz_dist = torch.linalg.norm(peg_head_wrt_goal.p[:, 1:], axis=1)
        ...
        pre_inserted = (peg_head_wrt_goal_yz_dist < 0.01) & (peg_wrt_goal_yz_dist < 0.01)
        ...
        insertion_reward = 5 * (1 - torch.tanh(5.0 * torch.linalg.norm(peg_head_wrt_goal_inside_hole.p, axis=1)))
