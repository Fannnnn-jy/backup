...
def initialize_data_sources():
    ...
    for category in ["cabinet_drawer", "cabinet_door", "chair", "bucket", "faucet"]:
        model_json = PACKAGE_ASSET_DIR / f"partnet_mobility/meta/info_{category}_train.json"
    ...
    DATA_GROUPS["partnet_mobility_cabinet"] = set(category_uids["cabinet_drawer"] + category_uids["cabinet_door"])
