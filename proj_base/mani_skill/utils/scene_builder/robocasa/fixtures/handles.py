...
class BarHandle(Handle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(xml="fixtures/handles/bar_handle.xml", length=length, *args, **kwargs)
...
class BoxedHandle(Handle):
    ...
    def __init__(self, length=0.24, handle_pad=0.04, *args, **kwargs):
        self.handle_pad = handle_pad
        super().__init__(xml="fixtures/handles/boxed_handle.xml", length=length, *args, **kwargs)
