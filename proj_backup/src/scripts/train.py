...
os.environ["WANDB_API_KEY"] = "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"
import sys
...
def _build_env_cfg(cfg: TrainConfig) -> ActiveMappingConfig:
    is_policy_3d = cfg.policy.class_name == "ActorCriticRGBCNNMaxpooling_3D"
    is_action_3d = cfg.env.action_mode == "xyz_quat"
    if is_policy_3d != is_action_3d:
        raise ValueError("ActorCriticRGBCNNMaxpooling_3D requires action_mode=xyz_quat, and vice versa.")
...
def main(cfg: TrainConfig) -> None:
    ...
    if cfg.logger.lower() == "wandb":
        runner = WandbOnPolicyRunner(
            runner,
            log_images=cfg.wandb_log_images,
