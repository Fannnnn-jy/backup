...
class Fixture(MujocoObject):
    ...
    def build(self, scene_idxs: list[int]):
        if self.is_articulation:
            self.articulation_builder.initial_pose = sapien.Pose(p=self.pos, q=self.quat)
    ...
    def horizontal_radius(self):
        ...
        """
        horizontal_radius_site = self.worldbody.find(f"./body/site[@name='{self.naming_prefix}horizontal_radius_site']")
