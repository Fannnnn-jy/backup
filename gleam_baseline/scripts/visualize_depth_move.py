...
# /datasets/v2p/current/fs/Junyi/data/scene_datasets/eval_128

def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Visualize ManiSkill depth observations.")
    parser.add_argument("--gleam-data-dir", default="/datasets/v2p/current/fs/Junyi/data/scene_datasets/eval_128", help="Path to GLEAM eval_128 dir.")
    ...
    parser.add_argument(
        ...
        default="both",
        help="Visualization mode (depth view uses RGB if --image-mode=rgb).",
    )
    parser.add_argument(
        "--image-mode",
        choices=("depth", "rgb"),
        default="depth",
        help="Camera image to render: depth (default) or rgb.",
    )
    parser.add_argument(
    ...
    try:
        while True:
            ...
            if render_images:
                ...
                window_name = "rgb" if args.image_mode == "rgb" else "depth"
