...
class FrankaMoveBenchmarkEnv(BaseEnv):
    ...
    def _default_sim_config(self):
        return SimConfig(
            ...
            spacing=5,
            control_freq=50,
            scene_config=SceneConfig(bounce_threshold=0.5, solver_position_iterations=8, solver_velocity_iterations=0),
        )
    ...
    def _load_scene(self, options: dict):
        self.ground = build_ground(
            self.scene,
            texture_file=os.path.join(os.path.dirname(__file__), "assets/black_grid.png"),
