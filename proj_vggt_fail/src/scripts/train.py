...
def _build_env_cfg(cfg: TrainConfig) -> ActiveMappingConfig:
    ...
    policies_need_xyz_quat = {"ActorCriticRGBCNNMaxpooling_3D", "ActorCriticRGBCNNRecurrent"}
    policies_need_xyz_delta_quat = {"ActorCriticRGBCNNPoseDelta", "ActorCriticRGBVGGTFrozenPoseDelta"}
...
def main(cfg: TrainConfig) -> None:
    ...
    wrap_runner = cfg.logger.lower() == "wandb" or cfg.pointcloud_eval.enabled
    if wrap_runner:
