...
class RotateCubeEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        high_table_boundary_file_name = (
            f"{PACKAGE_ASSET_DIR}/robots/trifinger/robot_properties_fingers/meshes/high_table_boundary.stl"
        )
    ...
    def compute_dense_reward(self, obs: Any, action: Array, info: dict):
        ...
        pose_reward = (
            object_dist_weight * (object_dist_reward + object_lift_reward) + object_rot_weight * object_rot_reward
        )
