...
class RecordEpisode(gym.Wrapper):
    ...
    def __init__(
        ...
        save_video_trigger: Callable[[int], bool] | None = None,
        max_steps_per_video: int | None = None,
    ...
    def flush_trajectory(
        ...
        for env_idx in env_idxs_to_flush:
            ...
            if save:
                ...
                def recursive_add_to_h5py(group: h5py.Group, data: dict | Array, key):
