...
class Drive(PhysxJointComponentStruct[physx.PhysxDriveComponent]):
    ...
    def create_from_entities(
        ...
        bodies0: Sequence[sapien.Entity | physx.PhysxRigidBaseComponent] = None,
        pose0: sapien.Pose | Pose = None,
        bodies1: Sequence[sapien.Entity | physx.PhysxRigidBaseComponent] = None,
        pose1: sapien.Pose | Pose = None,
        ...
        for i in scene_idxs:
            ...
            physx_drives.append(sub_scene.create_drive(bodies0[i], pose0[0].sp, bodies1[i], pose1[0].sp))
    ...
    def create_from_actors_or_links(
        scene: ManiSkillScene,
        entities0: Actor | Link = None,
        pose0: sapien.Pose | Pose = None,
        entities1: Actor | Link = None,
        pose1: sapien.Pose | Pose = None,
        scene_idxs: torch.Tensor = None,
    ) -> Drive:
    ...
    def set_drive_property_x(
        ...
        [x.set_drive_property_x(stiffness, damping, force_limit, mode) for x in self._objs]
    ...
    def set_drive_property_y(
        ...
        [x.set_drive_property_y(stiffness, damping, force_limit, mode) for x in self._objs]
    ...
    def set_drive_property_z(
        ...
        [x.set_drive_property_z(stiffness, damping, force_limit, mode) for x in self._objs]
