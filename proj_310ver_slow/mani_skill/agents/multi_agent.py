...
class MultiAgent(BaseAgent, Generic[T]):
    ...
    def action_space(self):
        return spaces.Dict({uid: agent.action_space for uid, agent in self.agents_dict.items()})

    @property
    def single_action_space(self):
        return spaces.Dict({uid: agent.single_action_space for uid, agent in self.agents_dict.items()})
    ...
    def get_controller_state(self):
        ...
        """
        return {uid: agent.get_controller_state() for uid, agent in self.agents_dict.items()}
